...
public class SecurityConfig {
    private static final String[] FOUNDER_SECURE_URLs = {
            "/api/v1/ecoles/add",
            "/api/v1/ecoles/getAll",
            "/api/v1/users/add",
            "/api/v1/users/search",
    };
    private static final String[] SECURE_URLs = {
            "/api/v1/ecoles/edit/**",
            "/api/v1/ecoles/detail/**",
    };
    ...
    private static final String[] S_AND_ADMINS_SECURE_URLs = {
            "/api/v1/ecoles/detail/**",
            "/api/v1/bulletins/getAllByEcole/**",
            "/api/v1/documents/**",
            "/api/v1/tranches/**",
    ...
    private static final String[] ADMINS_AND_ENS_SECURE_URLs = {
            "/api/v1/notes/add",
            "/api/v1/notes/edit",
            "/api/v1/devoirs/add",
            "/api/v1/devoirs/edit/**",
            ...
            "/api/v1/emargements/findByEns/**",
            "/api/v1/emargements/add",
    };
    private static final String[] ADMINS_AND_ETD_SECURE_URLs = {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> {
                            auth.requestMatchers(SECURE_URLs).hasAnyAuthority("FONDATEUR","ADMIN","SUPER_ADMIN");
                            auth.requestMatchers(FOUNDER_SECURE_URLs).hasAuthority("FONDATEUR");
                            auth.requestMatchers(SADMIN_SECURE_URLs).hasAuthority("SUPER_ADMIN");
                            auth.requestMatchers(UN_SECURE_URLs).hasAnyAuthority("ADMIN", "ETUDIANT","SUPER_ADMIN","ENSEIGNANT","FONDATEUR");
                            auth.requestMatchers(S_AND_ADMINS_SECURE_URLs).hasAnyAuthority("ADMIN","SUPER_ADMIN");
                            auth.requestMatchers(SCHOOL_SECURE_URLs).hasAnyAuthority("ETUDIANT","SUPER_ADMIN", "ENSEIGNANT", "ADMIN");
                            auth.requestMatchers(ADMINS_AND_ENS_SECURE_URLs).hasAnyAuthority("ADMIN","SUPER_ADMIN", "ENSEIGNANT");
                            auth.requestMatchers(ADMINS_AND_ETD_SECURE_URLs).hasAnyAuthority("ADMIN","SUPER_ADMIN", "ETUDIANT");
