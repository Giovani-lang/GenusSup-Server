...
import com.genus.GENUS_SUP.Mapper.UserMapper;
...
//    }
    ...
    @Override
    public UserResponse editUser(String username, UserRequest user)throws RessourceNotFoundException {
        try {
            User newUser = this.userRepo.findUserByUsername(username)
